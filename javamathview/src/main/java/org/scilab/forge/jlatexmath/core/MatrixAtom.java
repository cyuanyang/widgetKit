...
public class MatrixAtom extends Atom {
	...
	public static SpaceAtom hsep = new SpaceAtom(TeXConstants.UNIT_EM, 1f,
			0.0f, 0.0f);
	public static SpaceAtom semihsep = new SpaceAtom(TeXConstants.UNIT_EM,
			0.5f, 0.0f, 0.0f);
	public static SpaceAtom vsep_in = new SpaceAtom(TeXConstants.UNIT_EX, 0.0f,
			1f, 0.0f);
	public static SpaceAtom vsep_ext_top = new SpaceAtom(TeXConstants.UNIT_EX,
			0.0f, 0.4f, 0.0f);
	public static SpaceAtom vsep_ext_bot = new SpaceAtom(TeXConstants.UNIT_EX,
			0.0f, 0.4f, 0.0f);
				...
				case TeXConstants.TYPE_MULTICOLUMN:
					if (j == 0) {
						if (vlines.get(0) != null) {
							...
							hb.add(new HorizontalBox(vatBox, Hsep[0].getWidth()
									+ vatBox.getWidth(),
					...
					if (lastVline && vlines.get(j + 1) != null) {
						...
						Box vatBox = vat.createBox(env);
						if (j < col - 1) {
							hb.add(new HorizontalBox(vatBox, Hsep[j + 1]
